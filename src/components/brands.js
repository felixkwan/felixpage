            ...
            <div style={{
                ...
                <div className="grid-1-1">
                    <div className="brand-item">
                        ...
                        <Reveal>
                            <Tween from={{ text: '////// ////////////// //////////// ////////////// /////////////// //////// /////////// ///////'}}
                            to={{ text: 'We have created the brand logo with Monochrome who shoots elegant photos. All they need is a fashionable typography and it starts at the shape of shutter button.' }}
                            ease={x =>
                                x < 0.5 ? 8 * x * x * x * x : 1 - Math.pow(-2 * x + 2, 4) / 2
                            }
                            duration={.75}
